...
router.get('/:id', (req, res) => {
    ...
    matchedFriend ? res.status(200).json({result: `Friends #${friendId} found` , data: matchedFriend}) : res.status(404)._construct.json({result: `Friend #${friendID} not found`})
})
...
router.put('/:id', (req, res) => {
    ...
    if (oldFriend) {
        ...
        friend[oldFriendIndex] = updatedFriend
